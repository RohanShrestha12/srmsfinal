...
<div class="app-title">
    <div>
        <h1><i class="bi bi-collection me-2"></i>Bulk Results</h1>
        <p>Manage examination results in bulk for multiple students</p>
    </div>
</div>
        ...
        <div class="tile">
            <div class="tile-body">
                <div class="table-responsive">
                    <h3 class="tile-title">Bulk Results</h3>
                    <form enctype="multipart/form-data" action="admin/core/start_bulk" class="app_frm" method="POST" autocomplete="OFF">
